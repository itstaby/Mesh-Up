...
import meshup.app.fragments.ServiceFragment;
import meshup.wifimanagement.VisibleClient;
import meshup.wifimanagement.MeshUpBroadCastReceiver;
...
{	
	...
	ArrayList<ConnectedClient> connected;
	MeshupLocator meshupLocator;
	ActionBar actionBar;
