...
import meshup.app.APModeWorker;
import meshup.app.ClientModeWorker;
import meshup.app.fragments.ReachablePeersFragment;
import meshup.wifimanagement.CustomWifiManager;
...
public class MeshupService implements Runnable
{
	...
	public MeshupService(Thread l, CustomWifiManager cwm,WifiManager wm, ReachablePeersFragment rpf, FragmentHolder activity)
	{
		apManager=cwm;
		locator = l;
		this.wm = wm;
